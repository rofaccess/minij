...
public class SymbolTableVisitor implements Visitor {
	...
	public void visit(MainClassStatementList n) {
		...
		Category c = new Class();
		Symbol mainClass = new Symbol(n.i1.s,"root",c,n.i1.ln());		
		symbolTable.addSymbol(mainClass);
		
		Category m = new Method();
		Symbol mainMethod = new Symbol("main",mainClass.getIdentifier(),m,n.i2.ln());		
		symbolTable.addSymbol(mainMethod);
		
		currentScope = mainMethod.getIdentifier();		
	}
	...
	public void visit(ClassDeclSimple n) {
		...
		Category c = new Class();
		Symbol cl = new Symbol(n.i.s,"root",c,n.i.ln());		
		symbolTable.addSymbol(cl);		
		
		currentScope = cl.getIdentifier();
	...
	public void visit(ClassDeclExtends n) {
		...
		Category c = new Class();
		Symbol cl = new Symbol(n.i.s,n.j.toString(),c,n.i.ln());		
		symbolTable.addSymbol(cl);		
	...
	public void visit(VarDeclAssign n) {
		...
		Category v = new Variable(n.t.show(),n.e);
		Symbol var = new Symbol(n.i.s,currentScope,v,n.i.ln());		
		symbolTable.addSymbol(var);	
